        ...
        return cast(
            ...
            self._post(
                ...
                body=maybe_transform(
                    body, chatkit_upload_file_params.ChatKitUploadFileParams
                ),
                files=files,
...
class ChatKitWithStreamingResponse:
    def __init__(self, chatkit: ChatKit) -> None:
        ...
        self.upload_file = to_streamed_response_wrapper(chatkit.upload_file,)
...
class AsyncChatKitWithStreamingResponse:
    def __init__(self, chatkit: AsyncChatKit) -> None:
        ...
        self.upload_file = async_to_streamed_response_wrapper(chatkit.upload_file,)
