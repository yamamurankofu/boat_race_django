...
class Videos(SyncAPIResource):
    ...
    def poll(self, video_id: str, *, poll_interval_ms: int | Omit = omit,) -> Video:
    ...
    def retrieve(
        ...
        *,
        ...
        if not video_id:
            raise ValueError(
                f"Expected a non-empty value for `video_id` but received {video_id!r}"
            )
        return self._get(
            f"/videos/{video_id}",
            options=make_request_options(
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"variant": variant},
                    video_download_content_params.VideoDownloadContentParams,
                ),
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"prompt": prompt}, video_remix_params.VideoRemixParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class AsyncVideos(AsyncAPIResource):
    ...
    async def create_and_poll(
        ...
        *,
        ...
        return await self.poll(video.id, poll_interval_ms=poll_interval_ms,)

    async def poll(
        self, video_id: str, *, poll_interval_ms: int | Omit = omit,
    ) -> Video:
        """Wait for the vector store file to finish processing.
        ...
        while True:
            response = await self.with_raw_response.retrieve(
                video_id, extra_headers=headers,
            )
...
class VideosWithStreamingResponse:
    def __init__(self, videos: Videos) -> None:
        ...
        self.download_content = to_custom_streamed_response_wrapper(
            videos.download_content, StreamedBinaryAPIResponse,
        )
...
class AsyncVideosWithStreamingResponse:
    def __init__(self, videos: AsyncVideos) -> None:
        ...
        self.download_content = async_to_custom_streamed_response_wrapper(
            videos.download_content, AsyncStreamedBinaryAPIResponse,
        )
