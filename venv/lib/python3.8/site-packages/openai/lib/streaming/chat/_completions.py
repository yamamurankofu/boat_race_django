...
class ChatCompletionStreamState(Generic[ResponseFormatT]):
    ...
    def __init__(
        ...
        *,
        ...
        self._rich_response_format: type | Omit = response_format if inspect.isclass(
            response_format
        ) else omit
    ...
    def handle_chunk(
        ...
        return self._build_events(
            chunk=chunk, completion_snapshot=self.__current_completion_snapshot,
        )
        ...
        for choice in chunk.choices:
            ...
            if (
                ...
                choice_snapshot.message.parsed = from_json(
                    bytes(choice_snapshot.message.content, "utf-8"), partial_mode=True,
                )
        ...
        *,
        ...
        if choice_snapshot.message.content and not self._content_done:
            ...
            parsed = maybe_parse_content(
                response_format=response_format, message=choice_snapshot.message,
            )
...
def _convert_initial_chunk_into_snapshot(
    ...
    return cast(
        ...
        construct_type(
            ...
            value={"system_fingerprint": None, **data, "object": "chat.completion",},
        ),
    )
