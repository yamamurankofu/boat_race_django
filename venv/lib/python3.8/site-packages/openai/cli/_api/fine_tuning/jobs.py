...
def register(subparser: _SubParsersAction[ArgumentParser]) -> None:
    ...
    sub.add_argument(
        "-m", "--model", help="The model to fine-tune.", required=True,
    )
    sub.add_argument(
        "-F",
        "--training-file",
    ...
    sub.add_argument(
        "-s", "--suffix", help="A suffix to add to the fine-tuned model name.",
    )
    sub.add_argument(
        "-V", "--validation-file", help="The validation file to use for fine-tuning.",
    )
    sub.set_defaults(
    ...
    sub.add_argument(
        "-i", "--id", help="The ID of the fine-tuning job to retrieve.", required=True,
    )
    sub.set_defaults(
    ...
    sub.add_argument(
        "-l", "--limit", help="Number of fine-tuning jobs to retrieve.", type=int,
    )
    ...
    sub.add_argument(
        "-i", "--id", help="The ID of the fine-tuning job to cancel.", required=True,
    )
    sub.set_defaults(
    ...
    sub.add_argument(
        "-l", "--limit", help="Number of fine-tuning job events to retrieve.", type=int,
    )
    sub.set_defaults(
