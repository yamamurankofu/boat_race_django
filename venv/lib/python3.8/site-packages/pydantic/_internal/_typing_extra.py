...
def get_model_type_hints(
    obj: type[BaseModel], *, ns_resolver: NsResolver | None = None,
...
def get_cls_type_hints(
    obj: type[Any], *, ns_resolver: NsResolver | None = None,
) -> dict[str, Any]:
...
@deprecated(
    "`eval_type_lenient` is deprecated, use `try_eval_type` instead.", category=None,
)
