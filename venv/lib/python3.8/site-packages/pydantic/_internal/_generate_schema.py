...
ValidateCallSupportedTypes = Union[
    LambdaType, FunctionType, MethodType, partial,
]
...
def check_validator_fields_against_field_name(
    info: FieldDecoratorInfo, field: str,
) -> bool:
...
class GenerateSchema:
    ...
    def collect_definitions(self, schema: CoreSchema) -> CoreSchema:
        ...
        return core_schema.definitions_schema(
            schema, list(self.defs.definitions.values()),
        )
    ...
    def generate_schema(
        self, obj: Any, from_dunder_get_core_schema: bool = True,
    ) -> core_schema.CoreSchema:
            ...
            with self._ns_resolver.push(dataclass), self._config_wrapper_stack.push(
                ...
                if is_pydantic_dataclass(dataclass):
                    ...
                    fields = collect_dataclass_fields(
                        dataclass, typevars_map=typevars_map,
                    )
