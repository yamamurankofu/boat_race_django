...
class PathType:
    ...
    def __get_pydantic_core_schema__(
        ...
        return core_schema.with_info_after_validator_function(
            function_lookup[self.path_type], handler(source),
        )
    ...
    def __get_pydantic_core_schema__(
        ...
        return core_schema.json_or_python_schema(
            python_schema=core_schema.no_info_wrap_validator_function(
                validate_secret_value, inner_schema,
            ),
    ...
    def __get_pydantic_core_schema__(
        ...
        def get_json_schema(
            ...
            _utils.update_not_none(
                json_schema, type="string", writeOnly=True, format="password",
            )
            return json_schema

        json_schema = core_schema.no_info_after_validator_function(
            source, cls._inner_schema,  # construct the type
        )

        def get_secret_schema(strict: bool) -> CoreSchema:
            return core_schema.json_or_python_schema(
                python_schema=core_schema.union_schema(
                    [core_schema.is_instance_schema(source), json_schema,],
