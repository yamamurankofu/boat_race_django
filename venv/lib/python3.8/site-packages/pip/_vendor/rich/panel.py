    ...
    def __rich_console__(
            ...
            if excess_space:
                if align == "left":
                    return Text.assemble(
                        text, (character * excess_space, style), no_wrap=True, end="",
                    )
                elif align == "center":
                    left = excess_space // 2
                    return Text.assemble(
                    ...
                    return Text.assemble(
                        (character * excess_space, style), text, no_wrap=True, end="",
                    )
            return text
        ...
        if title_text is None or width <= 4:
            ...
            title_text = align_text(
                title_text, width - 4, self.title_align, box.top, border_style,
            )
        ...
        if subtitle_text is None or width <= 4:
            ...
            subtitle_text = align_text(
                subtitle_text, width - 4, self.subtitle_align, box.bottom, border_style,
            )
